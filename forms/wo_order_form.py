...
#--------------------Разметка формы расходного ордера--------------------------#


class wo_order_form_class:
    def on_form_open(
            db_path,
            add_functions_class,
            wo_order_window,
        ...
        wo_order_form_grid = QGridLayout()
        wo_order_form_grid.addWidget(
            numb_label, 0, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            numb_edit, 0, 1, alignment=QtCore.Qt.AlignCenter)

        wo_order_form_grid.addWidget(
            name_label, 1, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            name_edit, 1, 1, alignment=QtCore.Qt.AlignCenter)

        wo_order_form_grid.addWidget(
            cat_label, 2, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            cat_edit, 2, 1, alignment=QtCore.Qt.AlignCenter)

        wo_order_form_grid.addWidget(
            unit_label, 3, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            unit_edit, 3, 1, alignment=QtCore.Qt.AlignCenter)

        wo_order_form_grid.addWidget(
            quant_label, 4, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            quant_edit, 4, 1, alignment=QtCore.Qt.AlignCenter)

        wo_order_form_grid.addWidget(
            fio_label, 5, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            fio_edit, 5, 1, alignment=QtCore.Qt.AlignCenter)

        wo_order_form_grid.addWidget(
            receiver_label, 6, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addWidget(
            receiver_edit, 6, 1, alignment=QtCore.Qt.AlignCenter)
        ...
        wo_order_form_grid = QGridLayout()
        wo_order_form_grid.addWidget(
            wo_order_form_frame, 0, 0, alignment=QtCore.Qt.AlignCenter)
        wo_order_form_grid.addLayout(
            buttons_hbox, 1, 0, alignment=QtCore.Qt.AlignCenter)
